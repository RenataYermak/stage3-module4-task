...
public class AuthorRestControllerImpl implements AuthorController {

    private final AuthorService authorService;

    @Autowired
    public AuthorRestControllerImpl(AuthorService authorService) {
    ...
    @Override
    public AuthorResponseDto patch(Long id, JsonPatch patch) {
        return null;
    }
}