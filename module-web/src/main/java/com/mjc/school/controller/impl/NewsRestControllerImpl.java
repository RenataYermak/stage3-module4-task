...
public class NewsRestControllerImpl implements NewsController {

    private final NewsService newsService;

    @Autowired
    public NewsRestControllerImpl(NewsService newsService) {
    ...
    @Override
    public NewsResponseDto patch(Long id, JsonPatch patch) {
        return null;
    }
}